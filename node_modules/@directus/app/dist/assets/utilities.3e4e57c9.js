...
`)])],-1),rs=s("hr",null,null,-1),hs=s("h2",{id:"import-data-from-file",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#import-data-from-file"},"#"),e(" Import Data from File")],-1),cs=s("code",null,"multipart/form-data",-1),is=s("h3",{id:"request-body-3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#request-body-3"},"#"),e(" Request Body")],-1),ds=s("code",null,"multipart/form-data",-1),us=s("h3",{id:"returns-3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#returns-3"},"#"),e(" Returns")],-1),ps=s("p",null,"Empty body.",-1),_s=s("h3",{id:"rest-api-3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#rest-api-3"},"#"),e(" REST API")],-1),ms=s("pre",null,[s("code",null,`POST /utils/import/:collection
`)],-1),fs=s("h5",{id:"example-5",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#example-5"},"#"),e(" Example")],-1),ys=s("pre",null,[s("code",null,`POST /utils/import/articles
...
...
`)],-1),gs=s("h3",{id:"graphql-3",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#graphql-3"},"#"),e(" GraphQL")],-1),bs=s("p",null,"n/a",-1),js=s("hr",null,null,-1),xs=s("h2",{id:"export-data-to-a-file",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#export-data-to-a-file"},"#"),e(" Export Data to a File")],-1),qs=s("p",null,"Export a larger data set to a file in the File Library",-1),As=s("h3",{id:"query-parameters",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#query-parameters"},"#"),e(" Query Parameters")],-1),Ss=s("p",null,"Doesn\u2019t use any query parameters.",-1),Es=s("h3",{id:"request-body-4",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#request-body-4"},"#"),e(" Request Body")],-1),Rs=s("p",null,[s("code",null,"format"),e(),s("strong",null,"Required"),s("br"),e(" What file format to save the export to. One of "),s("code",null,"csv"),e(", "),s("code",null,"xml"),e(", "),s("code",null,"json"),e(".")],-1),Ts=s("code",null,"query",-1),Ps=s("strong",null,"Required",-1),vs=s("br",null,null,-1),Os=s("p",null,[s("code",null,"file"),e(),s("strong",null,"File Object"),s("br"),e(" Partial file object to tweak where / how the export file is saved.")],-1),Cs=s("h3",{id:"returns-4",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#returns-4"},"#"),e(" Returns")],-1),ks=s("p",null,"Empty body",-1),ws=s("h3",{id:"rest-api-4",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#rest-api-4"},"#"),e(" REST API")],-1),Fs=s("pre",null,[s("code",null,`POST /utils/export/:collection
`)],-1),Is=s("h5",{id:"example-6",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#example-6"},"#"),e(" Example")],-1),Bs=s("pre",null,[s("code",null,`POST /utils/export/articles
`)],-1),Ds=s("pre",null,[s("code",{class:"language-json"},[s("span",{class:"hljs-punctuation"},"{"),e(`
	...
	`),s("span",{class:"hljs-punctuation"},"}"),e(`
`),s("span",{class:"hljs-punctuation"},"}"),e(`
`)])],-1),Gs=s("h3",{id:"graphql-4",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#graphql-4"},"#"),e(" GraphQL")],-1),Ls=s("p",null,"n/a",-1),Ms=s("hr",null,null,-1),Us=s("h2",{id:"clear-the-internal-cache",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#clear-the-internal-cache"},"#"),e(" Clear the Internal Cache")],-1),Qs=s("p",null,"Resets both the data and schema cache of Directus. This endpoint is only available to admin users.",-1),Hs=s("h3",{id:"request-body-5",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#request-body-5"},"#"),e(" Request Body")],-1),Ns=s("p",null,"n/a",-1),Vs=s("h3",{id:"returns-5",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#returns-5"},"#"),e(" Returns")],-1),Ws=s("p",null,"Empty body",-1),Js=s("h3",{id:"rest-api-5",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#rest-api-5"},"#"),e(" REST API")],-1),Xs=s("pre",null,[s("code",null,`POST /utils/cache/clear
`)],-1),Ys=s("h3",{id:"graphql-5",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#graphql-5"},"#"),e(" GraphQL")],-1),zs=s("pre",null,[s("code",{class:"language-graphql"},[s("span",{class:"hljs-keyword"},"mutation"),e(` {
	utils_cache_clear
}
`)])],-1),ee="Utilities",te=!1,ae="REST and GraphQL API documentation on the Utilities collection in Directus.",ne="3 min read",le="page-reference",oe={__name:"utilities",setup($s,{expose:r}){const l={title:"Utilities",modularExtension:!1,description:"REST and GraphQL API documentation on the Utilities collection in Directus.",readTime:"3 min read",pageClass:"page-reference"};return r({frontmatter:l}),(Ks,Zs)=>{const a=o("router-link"),h=o("docs-wrapper");return c(),i(h,{frontmatter:l},{default:t(()=>[s("div",d,[u,p,_,m,f,y,g,b,j,x,q,A,S,E,R,T,P,v,O,C,k,w,F,I,B,D,G,L,M,U,Q,H,N,V,W,J,X,Y,z,$,K,Z,ss,es,ts,as,ns,ls,os,rs,hs,s("p",null,[e("Import multiple records from a JSON or CSV file into a collection. Relies on a "),cs,e(" encoded request, just like regular file uploads. Check "),n(a,{to:"/docs/reference/files#upload-a-file"},{default:t(()=>[e("Upload a File")]),_:1}),e(" for more information.")]),s("p",null,[e("The import endpoint expects the file structure to match "),n(a,{to:"/docs/reference/query#export"},{default:t(()=>[e("the export query parameter")]),_:1}),e(". For JSON, this is an array of objects, where every object is an item. For CSV, the first line has to be the columns header.")]),is,s("p",null,[e("Send the file in a "),ds,e(" request. See "),n(a,{to:"/docs/reference/files#upload-a-file"},{default:t(()=>[e("Upload a File")]),_:1}),e(" for more information.")]),us,ps,_s,ms,fs,ys,gs,bs,js,xs,qs,As,Ss,Es,Rs,s("p",null,[Ts,e(),Ps,vs,e(" The query object to use for the export. Supports the "),n(a,{to:"/docs/reference/query"},{default:t(()=>[e("global query parameters")]),_:1}),e(".")]),Os,Cs,ks,ws,Fs,Is,Bs,Ds,Gs,Ls,Ms,Us,Qs,Hs,Ns,Vs,Ws,Js,Xs,Ys,zs])]),_:1})}}};export{oe as default,ae as description,te as modularExtension,le as pageClass,ne as readTime,ee as title};
